library(dplyr)
sel.orig <- read.csv("/cbica/home/wenju/Reproducibile_paper/LifeStyleChart/data/smoking_var.tsv", stringsAsFactors = FALSE, sep = "\t")
...
write.csv(ukbb_all, "/cbica/home/wenju/Reproducibile_paper/LifeStyleChart/data/smoking.csv", row.names = FALSE)