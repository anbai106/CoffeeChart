...
dietary_file=/cbica/home/wenju/Reproducibile_paper/CoffeeChart/data/dietary_data_encoded.tsv
...
if [ ! -f ${output_file} ]; then
  ...
  bash /cbica/home/wenju/Project/CoffeeChart/2_u_shape/GAM/fit_gam.sh ${dietary_file} ${bag_file} ${cov_file} ${output_dir} ${trait}
else
  :
fi
